...
export default function ExperienceSection() {
  const experiences = [
    {
      icon: <FaBriefcase className="text-pink-400 text-2xl sm:text-3xl" />,
    ...
    {
      icon: <FaLaptopCode className="text-sky-400 text-2xl sm:text-3xl" />,
  ...
  return (
    <section
      id="experience"
      className="relative w-full py-16 sm:py-20 px-4 sm:px-6 lg:px-20 bg-black text-white"
    >
      <div className="max-w-6xl mx-auto z-10">
        <RevealWrapper>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-purple-400 to-pink-400 text-center mb-8 sm:mb-12">
        ...
        <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-2">
          {experiences.map((exp, index) => (
            <RevealWrapper key={index} delay={index * 0.2}>
              <div className="p-5 sm:p-6 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-md hover:bg-white/10 transition duration-300 h-full">
                ...
                <ul className="list-disc pl-5 text-xs sm:text-sm text-gray-300 space-y-2">
      ...
      <div className="absolute top-[-80px] left-[-80px] w-[200px] sm:w-[250px] h-[200px] sm:h-[250px] bg-yellow-500 rounded-full blur-[80px] sm:blur-[100px] opacity-20 -z-10" />
      <div className="absolute bottom-[-80px] right-[-80px] w-[200px] sm:w-[250px] h-[200px] sm:h-[250px] bg-pink-500 rounded-full blur-[80px] sm:blur-[100px] opacity-20 -z-10" />
    </section>
  );
}
